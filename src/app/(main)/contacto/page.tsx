            ...
            >
              ...
              <div className="space-y-6 pt-4">
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-[#3d332e] text-sm uppercase tracking-wider">Email</h3>
                ...
                <div className="flex items-center gap-4 group">
                  ...
                  <div>
                    <h3 className="font-bold text-[#3d332e] text-sm uppercase tracking-wider">Ubicación</h3>
