...
const GALLERY_IMAGES = [
  { src: "/images/products/products1.webp", w: 500, h: 700 },
  { src: "/images/left-1.png", w: 500, h: 400 },
  { src: "/images/right-2.png", w: 500, h: 600 },
  { src: "/images/products/products4.webp", w: 500, h: 500 },
  { src: "/images/left-2.png", w: 500, h: 800 },
  { src: "/images/products/products2.webp", w: 500, h: 450 },
  { src: "/images/right-1.png", w: 500, h: 650 },
  { src: "/images/blog/featured.png", w: 500, h: 400 },
  { src: "/images/products/products3.webp", w: 500, h: 600 },
];
            ...
            {GALLERY_IMAGES.map((img, i) => (
              <BlurFadeIn key={i} delay={(i % 3) * 0.1} yOffset={16}>
                <div className="break-inside-avoid group relative rounded-[2rem] overflow-hidden shadow-lg transition-all duration-500 hover:shadow-2xl hover:-translate-y-2">
                  <Image src={img.src} alt="Gallery" width={img.w} height={img.h} className="w-full h-auto object-cover transition-transform duration-700 group-hover:scale-110" />
                </div>
              </BlurFadeIn>
            ))}
          </div>
