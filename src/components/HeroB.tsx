      ...
      <div className="relative w-full max-w-7xl mx-auto px-8 md:px-16 h-full flex flex-col md:flex-row items-start md:items-center pb-10 sm:pb-16 md:py-0 z-20 gap-8 md:gap-12">
        ...
        <div className="w-full md:w-2/3 text-[#3d332e]">
          ...
          <BlurFadeIn delay={0.4}>
            <div className="w-12 h-0.5 bg-[#c6bfb7] md:mb-4 mb-2" />
            <p className="text-lg md:text-xl font-[family-name:var(--font-fraunces)] text-[#6b5a51] mb-0 md:mb-6">Pastelería inspirada en la cultura japonesa moderna.</p>
          </BlurFadeIn>

          <BlurFadeIn delay={0.55}>
            <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center pt-6 md:pt-10">
